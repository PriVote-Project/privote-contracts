...
import { logMagenta, logRed } from "@maci-protocol/contracts";
import { Deployment, EContracts } from "@maci-protocol/contracts";
...
task("benchmark", "Run benchmarks").setAction(async (_, hre) => {
  ...
  try {
    ...
    const { publishBatch } = await import("@maci-protocol/contracts/build/tasks/helpers/benchmarks");
